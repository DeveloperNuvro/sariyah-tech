...
const Products = () => {
  ...
  const seoData = useMemo(() => generateSEOMeta({
    ...
    description: 'Explore our premium digital products library. Get instant access to ebooks, templates, software, and digital resources.',
    keywords: ['digital products', 'ebooks', 'templates', 'software', 'digital downloads', 'premium resources'],
    type: 'website',
  }), []);
                      ...
                      <div className="p-3">
                        <Link to={`/product/${p.slug}`} className="block">
                          <div className="relative overflow-hidden rounded-xl">
                            ...
                            {p.thumbnail ? (
                              <img src={p.thumbnail} alt={p.title} className="w-full aspect-square object-cover rounded-xl transform transition-transform duration-500 group-hover:scale-105" loading="lazy" />
